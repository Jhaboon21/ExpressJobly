...
describe("GET /companies", function () {
  ...
  test("check filtering", async function () {
  ...
  test("check a more specific filter using all options", async function () {
    const res = await request(app)
        .get("/companies")
  ...
  test("Respond with 400 on invalid filter option", async function () {
    const res = await request(app)
        .get("/companies")
        .query({ minEmployees: 3, fake: "nah" });
